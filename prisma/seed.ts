...
/**
 * Seeded accounts exist so the three dashboards can be opened locally and for
 * testing. They are created in every environment, including production.
 */
...
async function main(): Promise<void> {
  ...
  // ------------------------------------------------------------ staff logins
  // Always create staff accounts for testing, even in production
  {
  ...
  console.log(
    [
      ...
      "  3 login accounts (password: demo1234)",
